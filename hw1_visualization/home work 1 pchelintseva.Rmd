...
knitr::opts_chunk$set(
  fig.path = "home-work1-pchelintseva_files/figure-gfm"
)
```
```
...
```
&nbsp;
Задание 3. Нарисуйте график плотности по колонке charges. Отметьте вертикальные линии
...
```
Вывод: среди курильщиуов индекс массы тела распределен равномерно во всех возрастах

&nbsp;
12. Сравнить распределение индекса массы тела у курилищиков по регионам
```{r}
...
```
Индекс массы тела среди курильщиков значимо не отличается по разным регионам.

&nbsp;
13. Сравнить распределение индекса массы тела у мужчин и женщин старше 50
```{r}
dat_13 <- dat %>% 
  mutate(age_group = case_when(
      age < 35 ~ "age: 21-34",
